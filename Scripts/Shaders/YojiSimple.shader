Shader "Yoji/Simple"
{
    Properties
    {
        ...
        [Toggle(PLANECLIP_ON)] _PlaneClip ("PlaneClip", Int) = 0
        [Toggle(BREAK_ON)] _BreakOn ("Break", Int) = 0
...
#pragma multi_compile _ PLANECLIP_ON
#pragma multi_compile _ BREAK_ON
